...
const BOT_NAME_FANCY = 'SHALA MD MINI BOT';
/*
const config = {
  ...
  PREFIX: '.',
  MAX_RETRIES: 3,
  GROUP_INVITE_LINK: 'https://chat.whatsapp.com/GnIVZcXcrUeBCcyTwHrlKP?mode=wwt',
  RCD_IMAGE_PATH: 'https://raw.githubusercontent.com/Nethmika-LK/Shala-MD-Database/refs/heads/main/image/Alive.jpg',
  NEWSLETTER_JID: '120363322195409882@newsletter',
  OTP_EXPIRY: 300000,
  OWNER_NUMBER: process.env.OWNER_NUMBER || '94704227534',
  CHANNEL_LINK: 'https://whatsapp.com/channel/0029VagCogPGufJ3kZWjsW3A',
  BOT_NAME: 'SHALA MD MINI BOT',
  BOT_VERSION: '1.0.0V',
  OWNER_NAME: 'NETHMIKA',
  IMAGE_PATH: 'https://raw.githubusercontent.com/Nethmika-LK/Shala-MD-Database/refs/heads/main/image/Alive.jpg',
  BOT_FOOTER: '*㋛ SHALA MINI BY NETHMIKA*',
  BUTTON_IMAGES: { ALIVE: 'https://raw.githubusercontent.com/Nethmika-LK/Shala-MD-Database/refs/heads/main/image/Alive.jpg' }
};
*/
...
"මාව හැදුවේ නෙත්මික අයියා" කියන්න.
...
await socket.sendMessage(sender, {
    ...
    break;
      ...
      try { await socket.sendMessage(sender, { image: { url: config.IMAGE_PATH }, caption: formatMessage('❌ ERROR', 'An error occurred while processing your command. Please try again.', BOT_NAME_FANCY) }); } catch(e){}
    }
